 ...
 *
 */
#ifndef __AUTOMOTIVE_CAN_V1_0_FUZZER_INTEGRATED_H__
#define __AUTOMOTIVE_CAN_V1_0_FUZZER_INTEGRATED_H__
...
namespace android::hardware::automotive::can::V1_0::implementation::fuzzer {
    ...
    using ::android::sp;
    struct CanSocketFuzzer{
    public:
        void fuzz(FuzzedDataProvider* mFuzzedDataProvider);
    };
    struct CanBusVirtualFuzzer: public CanBusVirtual{
    public:
        CanBusVirtualFuzzer(const std::string& ifname) : CanBusVirtual(ifname) {};
        void fuzz();
    };
    struct CanBusSlcanFuzzer: public CanBusSlcan{
    public:
        CanBusSlcanFuzzer(const std::string& uartName, uint32_t bitrate) : CanBusSlcan(uartName, bitrate) {};
        void fuzz();
        ~CanBusSlcanFuzzer() {   postDown(); }
    };
    struct CanBusNativeFuzzer: public CanBusNative{
    public:
        CanBusNativeFuzzer(const std::string& ifname, uint32_t bitrate) : CanBusNative(ifname, bitrate) {};
        void fuzz();
    };
...
#endif  // __AUTOMOTIVE_CAN_V1_0_FUZZER_INTEGRATED_H__
